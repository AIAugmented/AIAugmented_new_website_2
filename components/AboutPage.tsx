  ...
  return (
    <div className="absolute top-0 left-0 w-full min-h-screen bg-[#050505] overflow-x-hidden text-white">
      ...
      <section className="relative pt-48 pb-32 px-6 flex flex-col items-center text-center z-10 min-h-[80vh] justify-center overflow-hidden">
        ...
        {/* Background Visual - Strategic Chess/Depth Theme */}
        <div className="absolute inset-0 w-full h-full pointer-events-none select-none z-0">
           {/* Adjusted for visibility: Removed mix-blend-overlay, increased opacity */}
           <img 
             src="https://images.unsplash.com/photo-1586165368502-1bad197a6461?q=80&w=2600&auto=format&fit=crop"
             alt="Strategic Chess Game" 
             className="w-full h-full object-cover opacity-50 grayscale scale-[1.6] -translate-y-[15%]"
           />
           {/* Sophisticated Grey-to-Black Gradients for Readability - Reduced opacity in center */}
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
           <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#6e683b]/5 rounded-full blur-[120px]"></div>
           <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-[#3b6285]/5 rounded-full blur-[100px]"></div>
        </div>
      ...
      {/* 2. THE REALITY: COGNITIVE OVERLOAD */}
         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative z-10">
               ...
               <div className="space-y-6 text-lg text-gray-400 font-light leading-loose">
                 <p>
                    The modern executive is operating in a theater of infinite noise. Market signals, geopolitical fractures, and operational data now flow faster than human cognition can synthesize. You are not just busy; you are functioning beyond your biological design parameters.
                 </p>
                 <p>
                    Expanding your team only multiplies the friction. You do not need more opinions; you need aggressive filtering. You need an architecture that strips away the irrelevant to reveal the critical, enabling you to <span className="text-white border-b border-[#6e683b]/50">decide at the speed of conflict</span>.
                 </p>
               </div>
            </div>
      ...
      {/* WRAPPER FOR ORIGIN STORY + PROTOCOL SECTION TO SHARE STICKY ANIMATION */}
      <div className="relative bg-[#050505] border-y border-white/5 overflow-hidden">
         ...
         <section className="relative min-h-screen flex items-end pb-12 z-10">
            <div className="max-w-7xl mx-auto px-6 w-full grid grid-cols-1 lg:grid-cols-2">
               
               {/* Left Column: The Narrative Card */}
               <div className="max-w-md bg-white/[0.02] backdrop-blur-sm border border-white/10 p-6 md:p-8 shadow-[0_0_60px_rgba(0,0,0,0.3)] relative overflow-hidden group rounded-sm transition-all duration-1000 hover:shadow-[0_0_80px_rgba(255,255,255,0.05)] hover:bg-white/[0.03]">
                  {/* Subtle Glass Sheen */}
                  ...
                  <div className="absolute bottom-0 right-0 w-32 h-32 bg-[#6e683b]/10 rounded-full blur-[60px] pointer-events-none"></div>
                  ...
                  <div className="space-y-4 text-sm md:text-base text-white/80 font-light leading-relaxed mb-6">
                     ...
                     <p>
                        ...
                        I needed to simulate the consequences of a decision <span className="text-white border-b border-white/20 font-normal">before</span> I made it."
                     </p>
                     <p className="text-[#6e683b]">
                        "AI-Augmented was born from that necessity. It is not a chat tool. It is a war room."
                     </p>
                  </div>
               ...
               {/* Right Column: Visual Space - Empty to let particles show */}
               <div className="hidden lg:flex items-end justify-end p-12 pointer-events-none">
               </div>
            </div>
         </section>

         {/* 5. THE PROTOCOL: HOW IT WORKS */}
         <section className="py-32 px-6 relative z-10 bg-transparent">
           <div className="max-w-6xl mx-auto">
              <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-white/10 pb-8 bg-black/20 backdrop-blur-md p-8 rounded-sm border border-white/5">
                 <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                 ...
                 <div className="flex justify-center">
                    <div className="relative w-64 h-64">
                       ...
                       {/* Orbiting Particle Container - The Active Agent */}
      ...
      <section className="py-40 px-6 relative overflow-hidden text-center bg-[#050505]">
...
const StatBox = ({ value, label }: { value: string, label: string }) => (
   <div className="p-8 bg-[#050505] flex flex-col justify-center items-center text-center group hover:bg-[#0a0a0a] transition-colors">
...
const ProtocolCard = ({ step, title, icon: Icon, desc }: any) => (
   <div className="p-10 bg-[#050505]/40 backdrop-blur-sm border border-white/10 hover:bg-[#050505]/60 hover:border-white/20 transition-all duration-500 group relative overflow-hidden">
